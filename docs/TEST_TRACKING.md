...
2025-11-07  ┃ ✅ 测试文档完成
            ┃
2025-11-08  ┃ ✅ DatabaseService + GitService + ptyManager 测试完成 (31+83+66 用例，100% 通过，95%+/85%+/80%+ 覆盖)
            ┃
...
│ ██████████░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░ 23% │
├─────────────────────────────────────────────────────────┤
│ Tested:   5   (GitHubService, TerminalSnapshotService, DatabaseService, GitService, ptyManager) │
│ Missing:  17  (CodexService, WorktreeService, ...)     │
└─────────────────────────────────────────────────────────┘
...
|--------|--------|--------|--------|--------|----------|
| **P0 (Critical)** | 5 | 3 | 2 | 60% | 2025-11-21 |
...
Sprint 2 (P0核心)      ▓▓▓░░░░░░░░░░░ 33%  (DatabaseService完成)
...
| 日期 | 版本 | 变更内容 | 作者 |
|------|------|---------|------|
| 2025-11-08 | 1.3 | DatabaseService + GitService + ptyManager 测试完成 (31+83+66用例) | Claude |
